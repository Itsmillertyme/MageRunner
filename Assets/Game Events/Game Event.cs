...
public class GameEvent : ScriptableObject
{
    ...
    public void AddToListener(GameEventListener listener) => listeners.Add(listener);

    public void RemoveFromListener(GameEventListener listener) => listeners.Remove(listener);
