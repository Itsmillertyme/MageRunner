...
//public class EnemyGuardChaseMovement : MonoBehaviour, IEnemyMovementBehaviour {
//    #region Variables
...
//        // DEBUG orb for visualization
//        if (spawningDebugMode && debugOrb != null) {
//            GameObject orb = Instantiate(debugOrb, guardPosition, Quaternion.identity, transform.parent);
//            orb.name = $"{name}: Guard Position";
//        }
...
//        if (context.distToPlayer > profile.meleeIdealRange)
...
//        float ideal = profile.meleeIdealRange;
